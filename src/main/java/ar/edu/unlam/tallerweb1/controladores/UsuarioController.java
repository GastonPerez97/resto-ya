  ...
  @RequestMapping("/usuarios") public ModelAndView usuarios(HttpServletRequest request) {
  ...
  public ModelAndView validarRegistroUsuario(@ModelAttribute("formularioAgregarUsuario") FormularioAgregarUsuario formularioAgregarUsuario,
  ...
  public ModelAndView validarEliminarUsuario(@RequestParam("id") Long id, HttpServletRequest request) {
	  ...
	  if (usuarioService.validarEliminarUsuario(id) == true) {
		  ...
		  usuarioService.eliminarUsuarioPorId(id); return new ModelAndView("usuarios", modelo);
	  } else {
