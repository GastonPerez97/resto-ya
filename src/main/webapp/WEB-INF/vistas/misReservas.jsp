...
<div class="main-container">
  	<h1 class="text-center h1 display-3 bebas mb-4">Mis Reservas</h1>
               ...
               <div class="card-body">
				...
				<c:if test="${reserva.estadoReservaModel.idEstadoReserva == 1}">
					<div class="row d-flex justify-content-around align-items-center">
						<form action="/proyecto-limpio-spring-master/reserva/modificarMiReserva" class="form-inline" method="post">
