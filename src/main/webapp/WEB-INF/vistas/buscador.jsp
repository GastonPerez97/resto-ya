                            ...
                            <form:form action="buscar" method="POST" modelAttribute="formularioBusqueda">
                                <div class="form-group">
                                    <div class="mb-1 d-flex pl-0 justify-content-start align-items-center col-6">
                                        <form:radiobutton value="${formularioBusqueda.tiposBusqueda[0].ordinal()}" path="tipoBusquedaSeleccionada" class="mr-2 mb-1 radio-home" checked="true" /><span class="h5 mr-3">${formularioBusqueda.tiposBusqueda[0]}</span> &nbsp
                                        <form:radiobutton value="${formularioBusqueda.tiposBusqueda[1].ordinal()}" path="tipoBusquedaSeleccionada" class="mr-2 mb-1 radio-home" /><span class="h5">${formularioBusqueda.tiposBusqueda[1]}</span>
                                    </div>
